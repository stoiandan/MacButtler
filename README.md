...
## Usage
To use MacButtler just replace the placeholders from this command with your actual information:
...
## Testing
If you'd like to test the script only or just simply skip the installation of apps, you can use:
```zsh
