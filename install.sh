...
if [ -n "${SKIP_APPS:-}" ]; then
  ...
  brew install --cask battle-net halloy onyx transmission discord iina rustdesk utm dolphin vcmi signal visual-studio-code dotnet-sdk mist steam zed appcleaner
...
# copy Halloy config
mkdir -p ~"/Library/Application Support/halloy/"
